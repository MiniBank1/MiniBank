...
public class AccountService : IAccountService
{
    ...
    public async Task<(bool Success, string Message)> CreateTimeDepositAccountAsync(int userId)
    {
        ...
        return (true, "Time deposit account created successfully.");
    }
    ...
    public async Task<(bool Success, string Message)> DeleteTimeDepositAccountAsync(int userId)
    {
        ...
        {
            var transactionIds = relatedTransactions
        ...
        return (true, "Time deposit account, related cards, notifications, and transaction history have been successfully deleted.");
    }
